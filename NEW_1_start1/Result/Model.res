...
lifetime=s:persistent
result=s:0
treepath=s:1D Results\Materials\FR-4 (lossy - thermal anisotropic)\Dispersive\Eps' (Fit)
files=s:FR-4 (lossy - thermal anisotropic)_eps_re.sig
...
result=s:0
treepath=s:1D Results\Materials\FR-4 (lossy - thermal anisotropic)\Dispersive\Eps'' (Fit)
files=s:FR-4 (lossy - thermal anisotropic)_eps_im.sig
...
lifetime=s:persistent
result=s:0
treepath=s:1D Results\Materials\FR-4 (lossy - thermal anisotropic)\Dispersive\Eps TangD (Fit)
files=s:FR-4 (lossy - thermal anisotropic)_eps_tgd.sig
